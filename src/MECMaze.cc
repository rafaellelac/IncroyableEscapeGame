...
// Initialisation de MECMaze
void MECMaze::Init(){

    // Ajoute la texture de l'écran d'ordinateur à l'AssetManager
    ...
    // Configuration du texte de contexte
    ...
    // Configuration du texte suivant
